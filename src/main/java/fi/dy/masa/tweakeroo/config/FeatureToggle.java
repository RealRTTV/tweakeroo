...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_AUTO_LOGOUT               ("tweakAutoLogout",                     false, "",    "Automatically logs out when you reach a certain health threshold. Useful for AFK-ing (tweak automatically disables when your not in game)"),
    ...
    TWEAK_BREAK_REPLACE             ("tweakBreakReplace",                   false, "",    "When enabled, the tweak essentially instantly\nreplaces any block you break\nwith the block in your offhand."),
    ...
    TWEAK_CLICK_TO_COPY_CHAT_MESSAGE("tweakClickToCopyChatMessage",         false, "",    "When clicking on any chat message, it will be copied.\n(This will override all existing clickEvents)\n(on messages and will copy the full message instead of a portion:\n'<Username> message' instead of 'message')"),
    ...
    TWEAK_MOVING_PISTON_INDICATOR   ("tweakMovingPistonIndicator",          false, "",    "If enabled, a particle will indicate existing moving pistons like how barriers work."),
