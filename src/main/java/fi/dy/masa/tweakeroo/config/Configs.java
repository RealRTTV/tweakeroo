...
public class Configs implements IConfigHandler
{
    ...
    public static class Disable
    {
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_BOSS_BAR                = new ConfigBooleanHotkeyed("disableBossBar",                       false, "", "Removes the boss bar from the hud");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_F5_AVOID_BLOCKS         = new ConfigBooleanHotkeyed("disableF5AvoidBlocks",                 false, "", "Stops the F5 camera from changing distance if there are blocks in the way");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_PORTAL_TRAVEL           = new ConfigBooleanClient  ("disablePortalTravel",                  false, "", "Prevents you from going through nether portals");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_SLIME_BLOCK_BOUNCE      = new ConfigBooleanHotkeyed("disableSlimeBlockBounce",              false, "", "Removes the bounciness from a slime block");
